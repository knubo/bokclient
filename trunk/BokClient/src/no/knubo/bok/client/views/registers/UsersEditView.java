...
public class UsersEditView extends Composite implements ClickListener {
	...
	public UsersEditView(Messages messages, Constants constants,
			Elements elements) {
	...
	public static UsersEditView show(Messages messages, Constants constants,
			Elements elements) {
		if (me == null) {
	...
	public void init() {
		...
		AuthResponder.get(constants, messages, callback,
				"registers/users.php?action=all");
	}
